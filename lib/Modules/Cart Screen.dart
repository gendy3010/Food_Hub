...
class _CartScreenState extends State<CartScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 100,),
                      _buildButton(Icons.remove, _decrement, !_isIncrementing),
                      Padding(
                      ...
                      _buildButton(Icons.add, _increment, _isIncrementing),
                    ],
                  ),
  ...
  Widget _buildButton(IconData icon, VoidCallback onPressed, bool isActive) {
    return InkWell(
      onTap: onPressed,
